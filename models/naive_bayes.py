...
IMPORTANT:
This is the BASELINE Naive Bayes model.
...
MODEL_FILE = MODEL_DIRECTORY / "naive_bayes.pkl"
...
# GaussianNB uses var_smoothing for numerical stability.
# Keep the default value for the baseline experiment.
...
def main():
    ...
    # --------------------------------------------------------
    # 4. Create and train Gaussian Naive Bayes
    # --------------------------------------------------------

    print(
        "\n[4/6] Training Gaussian Naive Bayes..."
    )

    print(
        f"Variance smoothing : {VAR_SMOOTHING}"
    )
    ...
    print("\n")
    print("=" * 70)
    print("GAUSSIAN NAIVE BAYES COMPLETED SUCCESSFULLY")
    print("=" * 70)
